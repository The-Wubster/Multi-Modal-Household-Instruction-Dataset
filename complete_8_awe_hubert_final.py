...
with open('output_metrics.csv', 'a') as output_file:
    if unseen == True:
        ...
        writer_object.writerow(["hubert_awe_out_eng", "eng_105", n_shot, n_nearest, final_accs[0][0], final_accs[0][1], final_accs[0][2], final_accs[1][0], final_accs[1][1], final_accs[1][2], final_accs[2][0], final_accs[2][1], final_accs[2][2], restrict[0], restrict[1], restrict[2], restrict[3], restrict[4], object_not_present])
        output_file.close()