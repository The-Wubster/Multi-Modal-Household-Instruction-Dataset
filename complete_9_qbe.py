...
# Variables and constants which enable different elements of system:
unseen = True
first_time = False
...
# Calculating the probability of the different instructions and remapping them to the correct order:
print(type(validity_df))
...
#============================================================================================================================#
# Testing implementation where the recordings are split in two:
#============================================================================================================================#
...
# Writing metrics to an output file:
with open('output_metrics.csv', 'a') as output_file:
    if unseen == True:
        writer_object = csv.writer(output_file)
        writer_object.writerow(["mfcc_39", "eng_105", n_shot, n_nearest, final_accs[0][0], final_accs[0][1], final_accs[0][2], final_accs[1][0], final_accs[1][1], final_accs[1][2], final_accs[2][0], final_accs[2][1], final_accs[2][2], restrict[0], restrict[1], restrict[2], restrict[3], restrict[4], object_not_present])
        output_file.close()